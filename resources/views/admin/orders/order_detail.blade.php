          ...
          <div class="table-responsive">
            <table class="table">
              ...
              <tr>
                ...
                <td><?php echo getSiteCurrencyType(); ?><?php echo $orderDetail->subtotal ?></td>
              </tr>
              <!--<tr>
                <th>Tax (9.3%)</th>
                <td>$10.34</td>
             ...
             <?php if (!empty($orderDetail->coupon_discount)) { ?> <tr>
                ...
                <th>Coupon: <?php echo $orderDetail->coupon_code; ?>  <br/>(Discount: <?php echo $amount_coupon ?>)</th>
                <td><?php echo getSiteCurrencyType(); ?><?php echo $orderDetail->coupon_discount ?></td>
              </tr> 
              <?php } ?>              
              <tr>
                <th></th>
                <th>Tax:</th>
                <td><?php echo getSiteCurrencyType(); ?><?php echo $orderDetail->tax_amount ?></td>
              </tr>              
              <tr>
                <th></th>
                <th>Shipping:</th>
